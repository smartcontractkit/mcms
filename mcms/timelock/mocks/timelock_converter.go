...
import (
	...
	types "github.com/smartcontractkit/mcms/pkg/proposal/timelock/types"
)
...
func (_m *TimelockConverter) ConvertBatchToChainOperation(t types.BatchChainOperation, timelockAddress common.Address, minDelay string, operation types.TimelockOperationType, predecessor common.Hash) (mcmstypes.ChainOperation, common.Hash, error) {
	...
	var r0 mcmstypes.ChainOperation
	var r1 common.Hash
	var r2 error
	if rf, ok := ret.Get(0).(func(types.BatchChainOperation, common.Address, string, types.TimelockOperationType, common.Hash) (mcmstypes.ChainOperation, common.Hash, error)); ok {
		return rf(t, timelockAddress, minDelay, operation, predecessor)
	}
	if rf, ok := ret.Get(0).(func(types.BatchChainOperation, common.Address, string, types.TimelockOperationType, common.Hash) mcmstypes.ChainOperation); ok {
		r0 = rf(t, timelockAddress, minDelay, operation, predecessor)
	} else {
		r0 = ret.Get(0).(mcmstypes.ChainOperation)
	}

	if rf, ok := ret.Get(1).(func(types.BatchChainOperation, common.Address, string, types.TimelockOperationType, common.Hash) common.Hash); ok {
	...
	if rf, ok := ret.Get(2).(func(types.BatchChainOperation, common.Address, string, types.TimelockOperationType, common.Hash) error); ok {
...
func (_c *TimelockConverter_ConvertBatchToChainOperation_Call) Run(run func(t types.BatchChainOperation, timelockAddress common.Address, minDelay string, operation types.TimelockOperationType, predecessor common.Hash)) *TimelockConverter_ConvertBatchToChainOperation_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.BatchChainOperation), args[1].(common.Address), args[2].(string), args[3].(types.TimelockOperationType), args[4].(common.Hash))
	})
	return _c
}

func (_c *TimelockConverter_ConvertBatchToChainOperation_Call) Return(_a0 mcmstypes.ChainOperation, _a1 common.Hash, _a2 error) *TimelockConverter_ConvertBatchToChainOperation_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *TimelockConverter_ConvertBatchToChainOperation_Call) RunAndReturn(run func(types.BatchChainOperation, common.Address, string, types.TimelockOperationType, common.Hash) (mcmstypes.ChainOperation, common.Hash, error)) *TimelockConverter_ConvertBatchToChainOperation_Call {
	_c.Call.Return(run)
	return _c
}
