...
func (_m *Option) Execute(_a0 *mcms.executeOptions) {
	_m.Called(_a0)
}
...
//   - _a0 *mcms.executeOptions
func (_e *Option_Expecter) Execute(_a0 interface{}) *Option_Execute_Call {
	return &Option_Execute_Call{Call: _e.mock.On("Execute", _a0)}
}

func (_c *Option_Execute_Call) Run(run func(_a0 *mcms.executeOptions)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*mcms.executeOptions))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*mcms.executeOptions)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
