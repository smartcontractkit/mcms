...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.13.11
	github.com/smartcontractkit/chainlink-ton v0.0.0-20260128100045-09d00702f6f8
