...
require (
	...
	github.com/smartcontractkit/chainlink-canton v0.0.0-20260921093807-f6b69f48962e
	...
	github.com/smartcontractkit/chainlink-stellar/deployment v0.0.0-20260921193419-5f9a9d3b335a
