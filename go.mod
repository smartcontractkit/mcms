...
replace github.com/smartcontractkit/chainlink-solana => github.com/smartcontractkit/chainlink-internal-integrations/solana v0.0.0-00010101000000-000000000000
