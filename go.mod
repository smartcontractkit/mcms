...
require (
	...
	github.com/smartcontractkit/chainlink-sui v0.0.0-20260609152527-ee3b47c5ba2f
...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.108.0 // indirect
