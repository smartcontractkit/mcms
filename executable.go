...
func (e *Executable) SetRoot(ctx context.Context, chainSelector types.ChainSelector) (types.NativeTransaction, error) {
...
func (e *Executable) Execute(ctx context.Context, index int) (types.NativeTransaction, error) {
