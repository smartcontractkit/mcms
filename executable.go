...
func (e *Executable) SetRoot(ctx context.Context, chainSelector types.ChainSelector) (types.MinedTransaction, error) {
...
func (e *Executable) Execute(ctx context.Context, index int) (types.MinedTransaction, error) {
