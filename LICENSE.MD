...
Licensed Work:          MCMS Go Library
The Licensed Work is (c) 2024 SmartContract Chainlink Limited SEZC

Additional Use Grant: Any uses listed and defined
at [v1.0-CCIP-License-grants](https://github.com/smartcontractkit/ccip/blob/ccip-develop/contracts/src/v0.8/ccip/v1.0-CCIP-License-grants.md)
