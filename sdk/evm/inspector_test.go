...
func TestInspector_GetConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := inspector.GetConfig(ctx, NewEVMContractID(tt.address))
...
func TestInspector_GetOpCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := inspector.GetOpCount(ctx, NewEVMContractID(tt.address))
...
func TestInspector_GetRoot(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, validUntil, err := inspector.GetRoot(ctx, NewEVMContractID(tt.address))
...
func TestInspector_GetRootMetadata(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := inspector.GetRootMetadata(ctx, NewEVMContractID(tt.address))
