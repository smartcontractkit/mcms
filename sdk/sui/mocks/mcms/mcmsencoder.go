...
// RecentSeenSignedHashes provides a mock function with given fields: state, role, limit
func (_m *McmsEncoder) RecentSeenSignedHashes(state bind.Object, role byte, limit uint64) (*bind.EncodedCall, error) {
	ret := _m.Called(state, role, limit)
	...
	var r0 *bind.EncodedCall
	var r1 error
	if rf, ok := ret.Get(0).(func(bind.Object, byte, uint64) (*bind.EncodedCall, error)); ok {
		return rf(state, role, limit)
	}
	if rf, ok := ret.Get(0).(func(bind.Object, byte, uint64) *bind.EncodedCall); ok {
		r0 = rf(state, role, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*bind.EncodedCall)
		}
	...
	if rf, ok := ret.Get(1).(func(bind.Object, byte, uint64) error); ok {
		r1 = rf(state, role, limit)
	} else {
		r1 = ret.Error(1)
	}
...
// McmsEncoder_RecentSeenSignedHashes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RecentSeenSignedHashes'
type McmsEncoder_RecentSeenSignedHashes_Call struct {
	*mock.Call
}
...
//   - role byte
//   - limit uint64
func (_e *McmsEncoder_Expecter) RecentSeenSignedHashes(state interface{}, role interface{}, limit interface{}) *McmsEncoder_RecentSeenSignedHashes_Call {
	return &McmsEncoder_RecentSeenSignedHashes_Call{Call: _e.mock.On("RecentSeenSignedHashes", state, role, limit)}
}

func (_c *McmsEncoder_RecentSeenSignedHashes_Call) Run(run func(state bind.Object, role byte, limit uint64)) *McmsEncoder_RecentSeenSignedHashes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bind.Object), args[1].(byte), args[2].(uint64))
	})
	return _c
}

func (_c *McmsEncoder_RecentSeenSignedHashes_Call) Return(_a0 *bind.EncodedCall, _a1 error) *McmsEncoder_RecentSeenSignedHashes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *McmsEncoder_RecentSeenSignedHashes_Call) RunAndReturn(run func(bind.Object, byte, uint64) (*bind.EncodedCall, error)) *McmsEncoder_RecentSeenSignedHashes_Call {
	_c.Call.Return(run)
	return _c
}

// RecentSeenSignedHashesWithArgs provides a mock function with given fields: args
func (_m *McmsEncoder) RecentSeenSignedHashesWithArgs(args ...interface{}) (*bind.EncodedCall, error) {
	var _ca []interface{}
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for RecentSeenSignedHashesWithArgs")
	}
...
// McmsEncoder_RecentSeenSignedHashesWithArgs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RecentSeenSignedHashesWithArgs'
type McmsEncoder_RecentSeenSignedHashesWithArgs_Call struct {
	*mock.Call
}

// RecentSeenSignedHashesWithArgs is a helper method to define mock.On call
//   - args ...interface{}
func (_e *McmsEncoder_Expecter) RecentSeenSignedHashesWithArgs(args ...interface{}) *McmsEncoder_RecentSeenSignedHashesWithArgs_Call {
	return &McmsEncoder_RecentSeenSignedHashesWithArgs_Call{Call: _e.mock.On("RecentSeenSignedHashesWithArgs",
		append([]interface{}{}, args...)...)}
}

func (_c *McmsEncoder_RecentSeenSignedHashesWithArgs_Call) Run(run func(args ...interface{})) *McmsEncoder_RecentSeenSignedHashesWithArgs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-0)
		for i, a := range args[0:] {
			if a != nil {
...
func (_c *McmsEncoder_RecentSeenSignedHashesWithArgs_Call) Return(_a0 *bind.EncodedCall, _a1 error) *McmsEncoder_RecentSeenSignedHashesWithArgs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *McmsEncoder_RecentSeenSignedHashesWithArgs_Call) RunAndReturn(run func(...interface{}) (*bind.EncodedCall, error)) *McmsEncoder_RecentSeenSignedHashesWithArgs_Call {
	_c.Call.Return(run)
	return _c
}
...
// SeenSignedHashesCount provides a mock function with given fields: state, role
func (_m *McmsEncoder) SeenSignedHashesCount(state bind.Object, role byte) (*bind.EncodedCall, error) {
	ret := _m.Called(state, role)
...
// McmsEncoder_SeenSignedHashesCount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SeenSignedHashesCount'
type McmsEncoder_SeenSignedHashesCount_Call struct {
	*mock.Call
}
...
//   - state bind.Object
//   - role byte
func (_e *McmsEncoder_Expecter) SeenSignedHashesCount(state interface{}, role interface{}) *McmsEncoder_SeenSignedHashesCount_Call {
	return &McmsEncoder_SeenSignedHashesCount_Call{Call: _e.mock.On("SeenSignedHashesCount", state, role)}
}

func (_c *McmsEncoder_SeenSignedHashesCount_Call) Run(run func(state bind.Object, role byte)) *McmsEncoder_SeenSignedHashesCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bind.Object), args[1].(byte))
	})
	return _c
...
func (_c *McmsEncoder_SeenSignedHashesCount_Call) Return(_a0 *bind.EncodedCall, _a1 error) *McmsEncoder_SeenSignedHashesCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *McmsEncoder_SeenSignedHashesCount_Call) RunAndReturn(run func(bind.Object, byte) (*bind.EncodedCall, error)) *McmsEncoder_SeenSignedHashesCount_Call {
	_c.Call.Return(run)
	return _c
}

// SeenSignedHashesCountWithArgs provides a mock function with given fields: args
func (_m *McmsEncoder) SeenSignedHashesCountWithArgs(args ...interface{}) (*bind.EncodedCall, error) {
	var _ca []interface{}
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)

	if len(ret) == 0 {
		panic("no return value specified for SeenSignedHashesCountWithArgs")
	}
...
// McmsEncoder_SeenSignedHashesCountWithArgs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SeenSignedHashesCountWithArgs'
type McmsEncoder_SeenSignedHashesCountWithArgs_Call struct {
	*mock.Call
}

// SeenSignedHashesCountWithArgs is a helper method to define mock.On call
//   - args ...interface{}
func (_e *McmsEncoder_Expecter) SeenSignedHashesCountWithArgs(args ...interface{}) *McmsEncoder_SeenSignedHashesCountWithArgs_Call {
	return &McmsEncoder_SeenSignedHashesCountWithArgs_Call{Call: _e.mock.On("SeenSignedHashesCountWithArgs",
		append([]interface{}{}, args...)...)}
}

func (_c *McmsEncoder_SeenSignedHashesCountWithArgs_Call) Run(run func(args ...interface{})) *McmsEncoder_SeenSignedHashesCountWithArgs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-0)
		for i, a := range args[0:] {
			if a != nil {
...
func (_c *McmsEncoder_SeenSignedHashesCountWithArgs_Call) Return(_a0 *bind.EncodedCall, _a1 error) *McmsEncoder_SeenSignedHashesCountWithArgs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *McmsEncoder_SeenSignedHashesCountWithArgs_Call) RunAndReturn(run func(...interface{}) (*bind.EncodedCall, error)) *McmsEncoder_SeenSignedHashesCountWithArgs_Call {
	_c.Call.Return(run)
	return _c
}
