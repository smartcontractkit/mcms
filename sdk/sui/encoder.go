...
type AdditionalFields struct {
	...
	CompiledModules      [][]byte            // compiled Move modules, if deploying modules
	Dependencies         []models.SuiAddress // dependencies for compiled Move modules, if deploying modules
	PackageToUpgrade     string              // package to upgrade, if deploying modules
}
