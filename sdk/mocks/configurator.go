...
func (_m *Configurator[R]) SetConfigInputs(contract string, cfg config.Config) (R, error) {
	...
	var r0 R
	var r1 error
	if rf, ok := ret.Get(0).(func(string, config.Config) (R, error)); ok {
		return rf(contract, cfg)
	}
	if rf, ok := ret.Get(0).(func(string, config.Config) R); ok {
		r0 = rf(contract, cfg)
	} else {
		r0 = ret.Get(0).(R)
	}

	if rf, ok := ret.Get(1).(func(string, config.Config) error); ok {
		r1 = rf(contract, cfg)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Configurator_SetConfigInputs_Call[R]) Run(run func(contract string, cfg config.Config)) *Configurator_SetConfigInputs_Call[R] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(config.Config))
	})
	return _c
}
...
func (_c *Configurator_SetConfigInputs_Call[R]) RunAndReturn(run func(string, config.Config) (R, error)) *Configurator_SetConfigInputs_Call[R] {
	_c.Call.Return(run)
	return _c
}

// ToConfig provides a mock function with given fields: onchainConfig
func (_m *Configurator[R]) ToConfig(onchainConfig R) (*config.Config, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(R) (*config.Config, error)); ok {
		return rf(onchainConfig)
	}
	if rf, ok := ret.Get(0).(func(R) *config.Config); ok {
		r0 = rf(onchainConfig)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Configurator_ToConfig_Call[R]) Return(_a0 *config.Config, _a1 error) *Configurator_ToConfig_Call[R] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Configurator_ToConfig_Call[R]) RunAndReturn(run func(R) (*config.Config, error)) *Configurator_ToConfig_Call[R] {
	_c.Call.Return(run)
	return _c
}
