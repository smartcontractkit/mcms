...
func (_m *TimelockInspector) GetMinDelay(ctx context.Context, address string) (uint64, error) {
	ret := _m.Called(ctx, address)
...
// TimelockInspector_GetMinDelay_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMinDelay'
type TimelockInspector_GetMinDelay_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - address string
func (_e *TimelockInspector_Expecter) GetMinDelay(ctx interface{}, address interface{}) *TimelockInspector_GetMinDelay_Call {
	return &TimelockInspector_GetMinDelay_Call{Call: _e.mock.On("GetMinDelay", ctx, address)}
}

func (_c *TimelockInspector_GetMinDelay_Call) Run(run func(ctx context.Context, address string)) *TimelockInspector_GetMinDelay_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *TimelockInspector_GetMinDelay_Call) Return(_a0 uint64, _a1 error) *TimelockInspector_GetMinDelay_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TimelockInspector_GetMinDelay_Call) RunAndReturn(run func(context.Context, string) (uint64, error)) *TimelockInspector_GetMinDelay_Call {
	_c.Call.Return(run)
	return _c
}
