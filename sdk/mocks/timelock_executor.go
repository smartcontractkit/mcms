...
func (_m *TimelockExecutor) Execute(ctx context.Context, bop types.BatchOperation, timelockAddress string, predecessor common.Hash, salt common.Hash) (types.MinedTransaction, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.BatchOperation, string, common.Hash, common.Hash) (types.MinedTransaction, error)); ok {
		return rf(ctx, bop, timelockAddress, predecessor, salt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.BatchOperation, string, common.Hash, common.Hash) types.MinedTransaction); ok {
...
func (_c *TimelockExecutor_Execute_Call) Return(_a0 types.MinedTransaction, _a1 error) *TimelockExecutor_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TimelockExecutor_Execute_Call) RunAndReturn(run func(context.Context, types.BatchOperation, string, common.Hash, common.Hash) (types.MinedTransaction, error)) *TimelockExecutor_Execute_Call {
	_c.Call.Return(run)
	return _c
}
