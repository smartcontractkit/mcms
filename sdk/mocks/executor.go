...
func (_m *Executor) ExecuteOperation(ctx context.Context, metadata types.ChainMetadata, nonce uint32, proof []common.Hash, op types.Operation) (types.MinedTransaction, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.ChainMetadata, uint32, []common.Hash, types.Operation) (types.MinedTransaction, error)); ok {
		return rf(ctx, metadata, nonce, proof, op)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.ChainMetadata, uint32, []common.Hash, types.Operation) types.MinedTransaction); ok {
...
func (_c *Executor_ExecuteOperation_Call) Return(_a0 types.MinedTransaction, _a1 error) *Executor_ExecuteOperation_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Executor_ExecuteOperation_Call) RunAndReturn(run func(context.Context, types.ChainMetadata, uint32, []common.Hash, types.Operation) (types.MinedTransaction, error)) *Executor_ExecuteOperation_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Executor) SetRoot(ctx context.Context, metadata types.ChainMetadata, proof []common.Hash, root [32]byte, validUntil uint32, sortedSignatures []types.Signature) (types.MinedTransaction, error) {
	...
	var r0 types.MinedTransaction
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.ChainMetadata, []common.Hash, [32]byte, uint32, []types.Signature) (types.MinedTransaction, error)); ok {
		return rf(ctx, metadata, proof, root, validUntil, sortedSignatures)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.ChainMetadata, []common.Hash, [32]byte, uint32, []types.Signature) types.MinedTransaction); ok {
...
func (_c *Executor_SetRoot_Call) Return(_a0 types.MinedTransaction, _a1 error) *Executor_SetRoot_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Executor_SetRoot_Call) RunAndReturn(run func(context.Context, types.ChainMetadata, []common.Hash, [32]byte, uint32, []types.Signature) (types.MinedTransaction, error)) *Executor_SetRoot_Call {
	_c.Call.Return(run)
	return _c
}
