...
func (_m *Configurer) SetConfig(ctx context.Context, mcmAddr string, cfg *types.Config, clearRoot bool) (types.NativeTransaction, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *types.Config, bool) (types.NativeTransaction, error)); ok {
		return rf(ctx, mcmAddr, cfg, clearRoot)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *types.Config, bool) types.NativeTransaction); ok {
...
func (_c *Configurer_SetConfig_Call) Return(_a0 types.NativeTransaction, _a1 error) *Configurer_SetConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Configurer_SetConfig_Call) RunAndReturn(run func(context.Context, string, *types.Config, bool) (types.NativeTransaction, error)) *Configurer_SetConfig_Call {
	_c.Call.Return(run)
	return _c
}
