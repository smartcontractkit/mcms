...
func (_m *AptosRpcClient) EntryFunctionWithArgs(moduleAddress aptos.AccountAddress, moduleName string, functionName string, typeArgs []interface{}, args []interface{}, options ...interface{}) (*aptos.EntryFunction, error) {
	var _ca []interface{}
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(aptos.AccountAddress, string, string, []interface{}, []interface{}, ...interface{}) (*aptos.EntryFunction, error)); ok {
		return rf(moduleAddress, moduleName, functionName, typeArgs, args, options...)
	}
	if rf, ok := ret.Get(0).(func(aptos.AccountAddress, string, string, []interface{}, []interface{}, ...interface{}) *aptos.EntryFunction); ok {
	...
	if rf, ok := ret.Get(1).(func(aptos.AccountAddress, string, string, []interface{}, []interface{}, ...interface{}) error); ok {
...
func (_c *AptosRpcClient_EntryFunctionWithArgs_Call) Run(run func(moduleAddress aptos.AccountAddress, moduleName string, functionName string, typeArgs []interface{}, args []interface{}, options ...interface{})) *AptosRpcClient_EntryFunctionWithArgs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(aptos.AccountAddress), args[1].(string), args[2].(string), args[3].([]interface{}), args[4].([]interface{}), variadicArgs...)
	})
	return _c
}
...
func (_c *AptosRpcClient_EntryFunctionWithArgs_Call) RunAndReturn(run func(aptos.AccountAddress, string, string, []interface{}, []interface{}, ...interface{}) (*aptos.EntryFunction, error)) *AptosRpcClient_EntryFunctionWithArgs_Call {
	_c.Call.Return(run)
	return _c
}
